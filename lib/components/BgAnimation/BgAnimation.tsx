...
export function BgAnimation() {
  return (
    <div className="min-vh-screen pointer-events-none fixed bottom-0 left-0 z-[-1] flex w-full items-center justify-center overflow-hidden opacity-50 print:hidden">
      <svg
